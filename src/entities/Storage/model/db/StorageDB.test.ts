...
describe('StorageDB', () => {
  ...
  beforeEach(() => {
    ...
    Storage.prototype.getItem = jest.fn((key: StorageDBKeys) =>
  ...
  test('setStorages', () => {
    ...
    new StorageDB().setStorages([
      { id: 'id', name: 'name', productsCount: 20 },
    ]);
  ...
  test('updateStorage type: move', async () => {
    ...
    const expectedSourceStorage = {
      id: '1',
      name: 'name 1',
      productsCount: 90,
    };
    const expectedDestinationStorage = {
      id: '2',
      name: 'name 2',
      productsCount: 210,
    };
    ...
    expect(storage[StorageDBKeys.STORAGES][1]).toEqual(
      expectedDestinationStorage,
    );
  ...
  test('updateStorage multiple types: add, use, move, inventory', async () => {
    ...
    expect(afterAddStorage).toEqual({
      id: '1',
      name: 'name 1',
      productsCount: 150,
    });
    ...
    expect(afterUseStorage).toEqual({
      id: '3',
      name: 'name 3',
      productsCount: 250,
    });
    ...
    expect(afterInventoryStorage).toEqual({
      id: '2',
      name: 'name 2',
      productsCount: 150,
    });
