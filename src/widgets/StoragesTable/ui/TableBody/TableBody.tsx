...
const TableBody = (props: PropsType) => {
  ...
  return (
    <Tbody>
      <TableBodyLoader
        isLoading={isLoading}
        columnsLength={table.options.columns.length}
      >
              ...
              >
                <Flex justifyContent="flex-end">
                  <StorageMenu
                    ...
                    onAdd={() =>
                      openStorageModal(row.original, StorageActionModals.ADD)
                    }
                    onUse={() =>
                      openStorageModal(row.original, StorageActionModals.USE)
                    }
                    onMove={() =>
                      openStorageModal(row.original, StorageActionModals.MOVE)
                    }
                    onInventory={() =>
                      openStorageModal(
                        row.original,
